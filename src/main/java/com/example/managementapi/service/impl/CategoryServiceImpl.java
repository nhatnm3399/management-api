       ...
       try{
            if (jwtFilter.isAdmin()){
                if(validateCategoryMap(requestMap, false)){
                    ...
                    return ManagementUtils.getResponseEntity("Category Added Successfully", HttpStatus.OK);
                }
            } else {
            ...
            if(jwtFilter.isAdmin()){
                if(validateCategoryMap(requestMap, true)){
                  ...
                  if (!optional.isEmpty()){
                        ...
                        return ManagementUtils.getResponseEntity("Category Update Successfully",HttpStatus.OK);
                  }else {
                      return ManagementUtils.getResponseEntity(" ", HttpStatus.OK);
